...
//bool AIBaseBuildTool::Init(tagAIBaseParam* pBaseParam)
//{
//	//1.1读取配置文件 待添加
...
//
//	int nDLTemp = GetPrivateProfileInt(L"DL", L"DLTpye", 0, String2Lpcwstr(strIniPath));
//	//test
...
//bool AIBaseBuildTool::SetParam(tagAIBaseParam*pBaseParam)
//{
//	//2.1设置内存、显存分配
...
//unsigned char AIBaseBuildTool::GetScaleVal(Img &img, float fRawX, float fRawY)
//{
//	int nIVal = fRawX;
//	int nJVal = fRawY;
...
//bool AIBaseBuildTool::PreProcess(tagAIBaseParam*pBaseParam, tagAIBaseResultParam* pBaseResultParam,vector<DEF>vecInDefImg, vector<REF>vecInRefImg)
//{
//	pBaseParam = &m_tagAIBaseParams;
//	if (pBaseParam==NULL)
//	{
...
//					{
//						m_pData[b * 1 * nModelW*nModelH + nIndex] = ((float)ucPixVal / 255.0 - 0.485) / 0.229;
//					}
//
//				}
//			}
...
//bool AIBaseBuildTool::Execute(tagAIBaseParam*pBaseParam, tagAIBaseResultParam* pBaseResultParam)
//{
...
//	}
//	else if(pBaseParam->m_AIBuildToolType==dpDetectTool)
//	{
...
//	}
//	else if(pBaseParam->m_AIBuildToolType == dpClassifierTool)
//	{
//		doInferenceDetect(*context, stream, m_pData, m_pBuffers, m_pProbFloat, nCountImg, pBaseParam->m_AICommonParam.nInModelInputW, pBaseParam->m_AICommonParam.nInModelInputH, max(0,pBaseParam->m_AICommonParam.nInClassNum), m_bIsDdInput);
//	}
//
//	return TRUE;
//}

//int AIBaseBuildTool::Release()
//{
//	ICudaEngine* engine = (ICudaEngine*)m_pEngine;
//	IRuntime* runtime = (IRuntime*)m_pRuntime;
//	IExecutionContext*context = (IExecutionContext*)m_pContext;
