...
struct tagAISegRusult:tagAIBaseResultParam
{
	tagAISegRusult()
	{
		m_AIBuildToolType = dpSegmentionTool;
	}
...
class DPLEARNINGV10_API AISegmentBuildTool :
	public AIBaseBuildTool
{
public:
	AISegmentBuildTool();
	virtual ~AISegmentBuildTool();
public:
	...
	virtual AIBuildToolType GetInspectToolType() { return dpSegmentionTool; };

public:
	tagAISegRusult *m_pAISegResult;
	Img m_imgTemp[8];
