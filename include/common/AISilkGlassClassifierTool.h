...
class DPLEARNINGV10_API AISilkGlassClassifierTool :
	public AIBaseBuildTool
{
public:
	AISilkGlassClassifierTool();
	virtual ~AISilkGlassClassifierTool();
...
public:
	...
	virtual AIBuildToolType GetInspectToolType() { return dpSilkGlassClassifierTool; };
