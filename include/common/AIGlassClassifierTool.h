...
class DPLEARNINGV10_API AIGlassClassifierTool :
	public AIBaseBuildTool
{
public:
	AIGlassClassifierTool();
	virtual ~AIGlassClassifierTool();
...
public:
	...
	virtual AIBuildToolType GetInspectToolType() { return dpGlassClassifierTool; };
